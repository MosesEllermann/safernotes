...
const _strings = {
  'en': {
    ...
    'enterSyncServerUrl': 'Enter your self-hosted server URL',
    'invalidSyncServerUrl': 'Enter a valid HTTP or HTTPS URL',
    'useOfflineOnly': 'Use offline only',
    'offlineOnlyDescription':
        'No account and no server. Notes stay encrypted on this device.',
    ...
    'serverNotConfigured':
        'No sync server is configured. Enter your self-hosted server URL or use offline-only mode.',
    ...
    'syncServerDescription':
        'Enter the URL of your own Safernotes server. It is stored only on this device and used for all sync requests.',
    'syncServerSameOriginDescription':
  ...
  'de': {
    ...
    'syncServerUrl': 'Sync-Server-URL',
    'enterSyncServerUrl': 'Gib die URL deines selbst gehosteten Servers ein',
    'invalidSyncServerUrl': 'Gib eine gültige HTTP- oder HTTPS-URL ein',
    'useOfflineOnly': 'Nur offline verwenden',
    'offlineOnlyDescription':
        'Kein Konto und kein Server. Notizen bleiben verschlüsselt auf diesem Gerät.',
    'offlineVault': 'Offline-Tresor',
    'storedOnDevice': 'Auf dem Gerät gespeichert',
    ...
    'serverNotConfigured':
        'Kein Sync-Server eingerichtet. Gib deine selbst gehostete Server-URL ein oder verwende den Offline-Modus.',
    ...
    'syncServer': 'Sync-Server',
    'syncServerDescription':
        'Gib die URL deines eigenen Safernotes-Servers ein. Sie wird nur auf diesem Gerät gespeichert und für alle Sync-Anfragen verwendet.',
    'syncServerSameOriginDescription':
