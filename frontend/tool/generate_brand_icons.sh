...
render "$app_icon_source" 48 "$frontend_dir/android/app/src/main/res/mipmap-mdpi/ic_launcher.png"
render "$app_icon_source" 72 "$frontend_dir/android/app/src/main/res/mipmap-hdpi/ic_launcher.png"
render "$app_icon_source" 96 "$frontend_dir/android/app/src/main/res/mipmap-xhdpi/ic_launcher.png"
render "$app_icon_source" 144 "$frontend_dir/android/app/src/main/res/mipmap-xxhdpi/ic_launcher.png"
render "$app_icon_source" 192 "$frontend_dir/android/app/src/main/res/mipmap-xxxhdpi/ic_launcher.png"
